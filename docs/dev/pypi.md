...
[project]
name = "pyfullai"
description = "PoC of AI assisted Python app build"
authors = [{"name" = "David Kerins"}]
...
ls dist/
# pyfullai-1.2.3.tar.gz
# pyfullai-1.2.3-py3-none-any.whl
```
...
# Install from wheel
pip install dist/pyfullai-*.whl

# Verify installation
python -c "import pyfullai; print(pyfullai.__version__)"
...
1. Go to your project page: `https://pypi.org/project/pyfullai/`
...
```bash
# View on PyPI
open https://pypi.org/project/pyfullai/

# Install from PyPI
pip install pyfullai
