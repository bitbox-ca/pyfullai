...
- Installed with `pip install pyfullai`
...
- Installed with `pip install pyfullai[dev]`
...
# Creates:
# dist/pyfullai-X.Y.Z.tar.gz (source)
# dist/pyfullai-X.Y.Z-py3-none-any.whl (wheel)
```
