...
- **Images**:
  - `ghcr.io/bitbox-ca/pyfullai.www` - FastAPI web server
  - `ghcr.io/bitbox-ca/pyfullai.celery` - Celery workers
...
python -c "from pyfullai._version import version; print(version)"
...
- `ghcr.io/bitbox-ca/pyfullai.www`
- `ghcr.io/bitbox-ca/pyfullai.celery`
...
docker pull ghcr.io/bitbox-ca/pyfullai.www:main
...
services:
  www:
    image: ghcr.io/bitbox-ca/pyfullai.www:v1.2.3
```
