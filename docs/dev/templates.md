...
Templates are stored in the `pyfullai/templates/` directory:
...
The Jinja2 environment is configured in `pyfullai/services/jinja.py`:
...
env = Environment(
    loader=PackageLoader("pyfullai", "templates"),
...
app = FastAPI()
templates = Jinja2Templates(directory="pyfullai/templates")
...
```python
# pyfullai/services/jinja.py
from jinja2 import Environment, PackageLoader
from datetime import datetime

env = Environment(loader=PackageLoader("pyfullai", "templates"))
...
```python
# pyfullai/services/jinja.py
from pyfullai.conf import settings
...
```python
from pyfullai.services.jinja import env
...
from fastapi.templating import Jinja2Templates
from pyfullai.services.jinja import env, response_templates
