...
- **`pyfullai/conf/settings.py`**: Main Settings class
- **`pyfullai/conf/cache.py`**: Cache-specific settings
- **`pyfullai/conf/db.py`**: Database settings
- **`pyfullai/settings.py`**: Global settings instance
...
from pyfullai.conf.settings import Settings
...
```python
from pyfullai.conf.cache import CacheSettings
