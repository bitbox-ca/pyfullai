...
Models live in `pyfullai/models/`. Import and extend the shared `Base` from `pyfullai.models.base`.
...
from pyfullai.models.base import Base
...
- Models → `pyfullai/models/<domain>.py`
- Base class → `pyfullai/models/base.py` (do not modify)
...
- [ ] Model extends `Base` from `pyfullai.models.base`
- [ ] Model lives in `pyfullai/models/`
