...
- **One settings class**: The main `Settings` class lives at `pyfullai/conf/settings.py`. Always update this existing class — never create a new settings class.
...
class Settings(BaseSettings):
    ...
    project_name: str = Field(default="pyfullai", description="Human-readable project name")
...
1. Open `pyfullai/conf/settings.py`.
