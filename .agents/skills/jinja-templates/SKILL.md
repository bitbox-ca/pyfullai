...
The Jinja2 environment is configured in `pyfullai/services/jinja.py`. Templates live in `pyfullai/templates/`.
...
Add to `pyfullai/services/jinja.py`:
...
- [ ] Templates live in `pyfullai/templates/`
